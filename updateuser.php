...
<nav class="navbar bg-dark">
    ...
    <div class="container mt-5 bg-dark text-light ps-5 pe-5 pb-3 border border-success p-2 mb-2 border-opacity-75 rounded">
        <h1 class="h1 text-danger">Update User Data</h1>
    <form class="row g-3" method="post" action="checkUpdateUser.php">
      <div class="col-3 md-6">
            <label for="inputEmail4" class="form-label">EEID</label>
            <input type="text" class="form-control" id="inputEmail4" name="eeid" placeholder="E00013" required maxlength="6" value="<?php
             echo"".$_REQUEST['duser'];
            ?>" disabled>    
        </div>
          <div class="col-3">
          ...
          <div class="col-3">
            ...
            <input type="text" class="form-control" id="jt" placeholder="" name="jt"required>
          </div>
          <div class="col-3">
            <label for="inputPassword4" class="form-label">Department</label>
            <input type="text" class="form-control" id="department" placeholder="" name="d" onblur="checkPassword()" required>
          </div>
          <div class="col-3">
            <label for="inputEmail4" class="form-label">Business Unit</label>
            <input type="text" class="form-control" id="bs" name="bs" placeholder="" required  >
          </div>
          <div class="col-3">
            <label for="inputZip" class="form-label">Gender</label>
            <input type="text" class="form-control" id="g" name="gender" placeholder="" disabled>
          </div>
          <div class="col-3">
            <label for="inputZip" class="form-label">Ethnicit</label>
            <input type="text" class="form-control" id="g" name="e" placeholder=""  disabled>
          </div>
          <div class="col-3">
          ...
          <div class="col-3">
            ...
            <input type="date" class="form-control" id="age" name="hd" placeholder="" required >
          </div>
          <div class="col-3">
            <label for="inputZip" class="form-label">Anuual Salary</label>
            <input type="text" class="form-control" id="as" name="as" placeholder="" required maxlength="8" >
          </div>
          <div class="col-3">
          ...
          <div class="col-3">
            ...
            <input type="text" class="form-control" id="country" name="country" placeholder="India" disabled >
        </div>
          <div class="col-3">
            <label for="inputZip" class="form-label">City</label>
            <input type="text" class="form-control" id="country" name="city" placeholder="India" disabled >
        </div>
          <div class="col-3">
